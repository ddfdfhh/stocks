...
function formValidateFunctionTemplateLogin(
    rules,
    messages = {},
    btnid,
    formid,
    ...
    $("#" + formid).validate({
        ...
        submitHandler: function (form, event) {
            event.preventDefault();
            formid = $(form).attr("id");
            formAjaxSubmitWithServerValidationErrorLogin(
                btnid,
                formid,
                url,
                callbackSuccess,
...
function formValidateFunctionTemplateImage(
    rules,
    messages = {},
    btnid,
    formid,
...
function formAjaxSubmitWithServerValidationErrorLogin(
    btnid,
    formid,
    url,
    callbackSuccess = undefined,
...
function formAjaxWithBtnAndLoader(
    btnid,
    formid,
    url,
    callbackSuccess = undefined,
...
function formAjaxImageWithBtnAndLoader(
    btnid,
    formid,
    url,
    callbackSuccess = undefined,
