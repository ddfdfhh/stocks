            ...
            <div class="card">
              <div class="card-header">
                    <div class="d-flex justify-content-between">
                       ...
                       <div class="d-flex"> 
                              <div>
                                <button type="button" class="dt-button buttons-collection btn btn-label-primary dropdown-toggle me-2"  data-bs-toggle="dropdown" aria-expanded="false">
                                <span><i class="bx bx-export me-sm-2"></i> <span class="d-none d-sm-inline-block">Export</span></span>
                                </button>
                                <ul class="dropdown-menu">
                                
                                            <li>
                                              <a class="dropdown-item" href="{{route(strtolower($module).'.export',['type'=>'excel'])}}?{{http_build_query($_GET)}}"><span><i class="bx bx-printer me-2"></i>XLS</span></a>
                                              <a class="dropdown-item" href="{{route(strtolower($module).'.export',['type'=>'csv'])}}?{{http_build_query($_GET)}}"><span><i class="bx bx-file me-2"></i>CSV</span></a>
                                              <a class="dropdown-item" href="{{route(strtolower($module).'.export',['type'=>'pdf'])}}?{{http_build_query($_GET)}}"><span><i class="bx bxs-file-pdf me-2"></i>PDF</span></a>
                 ...
                 <button class="btn btn-primary" type="button" onclick="load_form('{!!$module!!}','add','{!!route(strtolower($module).'.loadAjaxForm')!!}',null)" aria-controls="offcanvasEnd">Create {{$module}}</button>
                     ...
                     <div class="d-flex justify-content-between">
                      ...
                      <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="javascript:multiSelectCheckBoxAction('Active','status','{!!route('table_filed_update')!!}','{!!$plural_lowercase!!}')">Approve</a></li>
                          <li><a class="dropdown-item" href="javascript:multiSelectCheckBoxAction('In-Active','status','{!!route('table_filed_update')!!}','{!!$plural_lowercase!!}')">Reject</a></li>
