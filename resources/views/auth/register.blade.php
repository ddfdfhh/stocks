...
@endsection
@section('css')
<link rel="stylesheet" href="{{asset('assets/css/password-strength.css')}}">
@endsection
@section('content')
    <div class="card card-primary">
        ...
        <div class="card-body pt-1">
            <form method="POST" action="{{ route('register') }}" id="registration" novalidate>
                @csrf
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <ul class="pswd_info" id="passwordCriterion">
                                    ...
                                    <li data-criterion="special" class="invalid">&#10066; At least <strong>one Special Characters </strong></li>
                            </ul>
                    </div>
                    ...
                    <div class="col-md-12 mt-4">
                        <div class="form-group">
                            <button type="submit" id="registration_btn" class="btn btn-primary btn-lg btn-block" tabindex="4">
                                Register
