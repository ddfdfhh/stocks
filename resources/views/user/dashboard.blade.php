    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row gx-2 row-bordered m-0">
            ...
            <div class="col-md-6 col-6">
                ...
                <div class="card ">
                    <div class="card-header bg-info text-white d-flex justify-content-between flex-wrap">
                        <h5 class="card-title mb-0 text-white ">Today Followup Leads <i class="fa fa-long-arrow-right"></i> </h5>
            ...
            <div class="col-md-6 col-6">
                ...
                <div class="card ">
                    <div class="card-header bg-info text-white d-flex justify-content-between flex-wrap">
                        <h5 class="card-title mb-0 text-white ">Upcoming Followup Leads <i class="fa fa-long-arrow-right"></i> </h5>
                        <a href="{{ route('leads.followup_leads') }}" class="text-white btn btn-xs btn-warning"
                            style="margin-left:5px">View All</a>
                    </div>
                    <div class="table-responsive mt-2">
        ...
        <div class="row gx-2 row-bordered m-0">
            ...
            <div class="col-md-6 col-6">
                ...
                <div class="card ">
                    <div class="card-header bg-info text-white d-flex justify-content-between flex-wrap">
                        <h5 class="card-title mb-0 text-white ">Latest Leads <i class="fa fa-long-arrow-right"></i> </h5>
